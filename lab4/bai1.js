...
document.writeln("Danh sách sinh viên theo thứ tự tuổi từ thấp đến cao:"); 
document.writeln("<br>")
students.forEach((student) => document.writeln(`${student.getFullName()} - Tuổi: ${student.getAgeByDay()} ngày`+"<br>") );
document.writeln("<br>")
// In ra width và height của màn hình
document.writeln(`Width: ${window.innerWidth}px - Height: ${window.innerHeight}px`);